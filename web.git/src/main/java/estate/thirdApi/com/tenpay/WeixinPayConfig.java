...
public class WeixinPayConfig {
    ...
    public static String MCH_ID = "db426a9829e4b49a0dcac7b4162da6b6";//商户ID
	//应用对应的密钥
	...
	public static final String notify_url = "http://127.0.0.1:8180/tenpay_api_b2c/payNotifyUrl.jsp";
